...
#include <hdl_localization/SetGlobalLocalizationEngine.h>
...
class GlobalLocalizationNodelet : public nodelet::Nodelet {
public:
  using PointT = pcl::PointXYZI;

  GlobalLocalizationNodelet() {
  }
  virtual ~GlobalLocalizationNodelet() {
  }

  void onInit() override {
    set_engine(private_nh.param<std::string>("global_localization_engine", "FPFH_RANSAC"));
    set_engine_server = private_nh.advertiseService("/hdl_global_localization/set_engine", &GlobalLocalizationNodelet::set_engine, this);
    set_global_map_server = private_nh.advertiseService("/hdl_global_localization/set_global_map", &GlobalLocalizationNodelet::set_global_map, this);
    query_server = private_nh.advertiseService("/hdl_global_localization/query", &GlobalLocalizationNodelet::query, this);
  }
...
private:
  ...
  bool set_engine(hdl_localization::SetGlobalLocalizationEngine::Request& req, hdl_localization::SetGlobalLocalizationEngine::Response& res) {
    ROS_INFO_STREAM("Set Global Localization Engine");
    return set_engine(req.engine_name.data);
  }

  bool set_global_map(hdl_localization::SetGlobalMapRequest& req, hdl_localization::SetGlobalMapResponse& res) {
  ...
  bool query(hdl_localization::QueryGlobalLocalizationRequest& req, hdl_localization::QueryGlobalLocalizationResponse& res) {
...
PLUGINLIB_EXPORT_CLASS(hdl_localization::GlobalLocalizationNodelet, nodelet::Nodelet)
